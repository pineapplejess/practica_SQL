...
create table flotakc.revisiones(
	...
	id_fecha_revision date not null default '400-01-01',
...
insert into flotakc.revisiones (id_revisiones,id_km_revision, id_fecha_revision,id_importe_revision,id_moneda) values ('R001',50000,'2018-08-07',100,'M01');
insert into flotakc.revisiones (id_revisiones,id_km_revision, id_fecha_revision,id_importe_revision,id_moneda) values ('R002',41000,'2020-04-01',120,'M02');
insert into flotakc.revisiones (id_revisiones,id_km_revision, id_fecha_revision,id_importe_revision,id_moneda) values ('R003',200,'2021-09-04',50,'M01');
insert into flotakc.revisiones (id_revisiones,id_km_revision, id_fecha_revision,id_importe_revision,id_moneda) values ('R004',21455,'2021-09-04',480,'M02');
insert into flotakc.revisiones (id_revisiones,id_km_revision, id_fecha_revision,id_importe_revision,id_moneda) values ('R005',8785,'2019-06-03',412,'M01');
insert into flotakc.revisiones (id_revisiones,id_km_revision, id_fecha_revision,id_importe_revision,id_moneda) values ('R006',9541,'2019-06-03',552,'M02');
insert into flotakc.revisiones (id_revisiones,id_km_revision, id_fecha_revision,id_importe_revision,id_moneda) values ('R007',77456,'2017-06-03',130,'M01');
insert into flotakc.revisiones (id_revisiones,id_km_revision, id_fecha_revision,id_importe_revision,id_moneda) values ('R008',9321,'2022-06-03',78,'M02');
insert into flotakc.revisiones (id_revisiones,id_km_revision, id_fecha_revision,id_importe_revision,id_moneda) values ('R009',515884,'2020-08-01',852,'M02');
...
alter table flotakc.vehiculos 
add constraint id_revisiones_PK foreign key (id_revisiones)
references flotakc.revisiones (id_revisiones);
